...
<section id="topbar" class="d-none d-lg-block">
    <div class="container clearfix">
        ...
        <div class="contact-info float-right"> <i class="fa fa-envelope-o"></i>  <a href="mailto:info@mavenup.com">info@mavenup.com</a>
            <i class="fa fa-phone"></i>  <a href="tel:+18668677866">+1-866-867-7866</a>
            ...
            <div class="nav-align">
                <nav class="main-nav d-none d-lg-block">
                    <ul>
                        ...
                        <li class="drop-down"><a href="{{route('admin.about')}}">About</a>
                            <ul>
                        ...
                        <li><a href="https://www.mavenup.com/blog/">Blog</a>
                        </li>
...
<script src="//code.tidio.co/uy9pbh4pnof3cbv83kwcik7qjxd9wa5k.js"></script>
</header>
<!-- #header -->
